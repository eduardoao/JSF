...
public class VendasBean {
	...
	public BarChartModel getVendasModel() {		
	    ...
	    ChartSeries vendaSerie2014 = new ChartSeries();
	    vendaSerie2014.setLabel("Vendas 2014");

	   vendas = getVendas(6789);

	    for (Venda venda : vendas) {
	    	vendaSerie2014.set(venda.getLivro().getTitulo(), venda.getQuantidade());
	    }

	    model.addSeries(vendaSerie2014);
